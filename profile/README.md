...
| [fabrica](https://github.com/civitas-io/fabrica) | The context layer — tools-as-code, a tiered sandbox (subprocess → OS-isolated → Firecracker microVM), skills, memory, prompts. Governed by Presidium over real REST+mTLS | Anyone building agents that need to run untrusted, model-generated code safely | [`fabrica-context` v0.4.0](https://github.com/civitas-io/fabrica/releases/tag/v0.4.0) · 2026-08-25 |
